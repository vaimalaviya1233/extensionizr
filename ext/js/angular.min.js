			...
			<div id="hidden-section">
				...
				<div id="customize-section" class="clearfix">
					...
					<div class="customize-section">
						...
						<label><input type="checkbox" value="jquerymin">Add jQuery 1.8.3
							<a class="more_info" target="_blank" href="http://jquery.com" data-content="Add jquery 1.7.2 to your extension"></a>
						</label>
						<label><input type="checkbox" value="angular">Add Angular.js 1.0.3
							<a class="more_info" target="_blank" href="http://angularjs.org" data-content="Add Angular 1.0.3 to your extension"></a>
						</label>
					</div>
					<div class="customize-section special-section">
						<h3>URL permissions
							<a class="more_info" target="_blank" href="http://developer.chrome.com/extensions/manifest.html#permissions" data-content="Url permissions are a match pattern set that your gives extension access to one or more hosts."></a>
						</h3>
						<!--<label><input type="checkbox" name="match-pattern" value="match-pattern" id="match-pattern"> Match pattern: </label>-->
						<input type="text" class="match_pattern" name="uri-perms" value=""> <span>Separated by ";" (https://*/* ; http://google.com/*)</span>
					</div>
					<div class="customize-section">
